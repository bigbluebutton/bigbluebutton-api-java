...
public enum ApiMethod {
    ...
    GET_RECORDING_TEXT_TRACKS("getRecordingTextTracks"), PUT_RECORDING_TEXT_TRACK("putRecordingTextTrack"),
    HOOKS_CREATE("hooks/create"), HOOKS_LIST("hooks/list"), HOOKS_DESTROY("hooks/destroy");
