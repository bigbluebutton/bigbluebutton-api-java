...
public class HooksDestroyParameters extends BaseParameters {

    @Getter
    protected String hookId;

    public HooksDestroyParameters(String hookId) {
        this.hookId = hookId;
    }

    public List<NameValuePair> getQueryParms() throws UnsupportedEncodingException {
        List<NameValuePair> params = new ArrayList<NameValuePair>();
        addStringValue(params, ApiParams.HOOK_ID, getHookId());
        return params;
    }
}
